...
export const PromptForm: React.FC<PromptFormProps> = ({ 
  ...
  return (
    <div 
      className={`absolute bottom-0 right-0 z-20 bg-gray-900/80 backdrop-blur-lg border-t border-gray-700 p-4 transition-all duration-300 ease-in-out ${isSidebarOpen ? 'left-0 md:left-[260px]' : 'left-0'}`}
    >
